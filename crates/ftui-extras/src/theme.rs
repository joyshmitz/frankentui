...
const THEMES: [ThemePalette; 41] = [
    ThemePalette {
        ...
        accent_error: PackedRgba::rgb(255, 90, 130),
    ...
    ThemePalette {
        ...
        accent_success: PackedRgba::rgb(10, 100, 45),
        ...
        syntax_string: PackedRgba::rgb(10, 100, 45),
